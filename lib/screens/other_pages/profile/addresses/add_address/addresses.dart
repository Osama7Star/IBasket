...
class Addresses extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: CustomAppBar(
            context: context, text: 'Addresses', color: CustomColors.white),
        body: ListView(children: [
          Card(
            ...
            child: ProfileList(
                icon1: Icons.home,
                text: 'Home',
                text2: 'Şirinevler kasımpaşa mah.Şirinevler kasımpaşa mah.',
                row: true,
                icon2: Icons.delete,
                function: () {
                  showDialog(
          ...
          Card(
            ...
            child: ProfileList(
                ...
                text: 'Work',
                text2:
                    'Kervan geçmez sok. no.5 Kervan geçmez sok. no.5 Kervan geçmez sok. no.5',
                row: true,
                icon2: Icons.delete,
                function: () {
                  showDialog(
