...
class InputFieldW extends StatefulWidget {
   InputFieldW({Key? key, this.showData = false,required this.function,required this.function1,required this.controller,this.passwordSuffixIcon=Icons.mic}) : super(key: key);
    bool showData;
    Function() function ;
    Function() function1 ;
