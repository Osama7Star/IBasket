class RestaurantsModel{
  ...
  RestaurantsModel({ required this.id,required this.name, required this.deliveryTime,required this.minimum,required this.rating,required this.image,required this.restaurantDelivery ,required this.getirDelivery });
}

List<RestaurantsModel> restaurantsList = [
  RestaurantsModel(id:1,name:'Hot Döner (Şişli Merkez Mah.)',deliveryTime:"40 - 50 min",minimum:20,rating:5.4,image:'https://cdn.getiryemek.com/restaurants/1604067657962_1125x522.jpeg'      ,getirDelivery: true,restaurantDelivery: false ),
  ...
  RestaurantsModel(id:1,name:'Ayça Kasap Burger (Fulya Mah.)',deliveryTime:"40 - 50 min",minimum:20,rating:2.4,image:'https://cdn.getiryemek.com/restaurants/1581949154562_1125x522.jpeg'     ,getirDelivery: true,restaurantDelivery: false ),
  ...
  RestaurantsModel(id:1,name:'Hacıoğlu (Mecidiyeköy Mah.)',deliveryTime:"40 - 50 min",minimum:20,rating:1.4,image:'https://cdn.getiryemek.com/restaurants/1605902397199_1125x522.jpeg',getirDelivery: false,restaurantDelivery: true ),
  RestaurantsModel(id:1,name:'Chinese Time (Cihannüma Mah.)',deliveryTime:"40 - 50 min",minimum:20,rating:3.3,image:'https://cdn.getiryemek.com/restaurants/1617024822685_1125x522.jpeg',getirDelivery: true,restaurantDelivery: false ),
